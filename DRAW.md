...
Event `kind`: `"mouse"`, `"kbd"`, `"resize"`, `"quit"`. Mouse `button` is the Plan 9 bitfield (1=left, 2=middle, 4=right). `r` is a Unicode codepoint. Color is `"#RRGGBB"`. Default font only.
